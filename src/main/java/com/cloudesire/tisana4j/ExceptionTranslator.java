...
public interface ExceptionTranslator
{
     ...
     * @param responseMessage  HTTP response status phrase
     * @param bodyMessage      Content of the response
     * @param returnMessageRef if method returns null you may set a response message here
     * @param headers          HTTP headers
     *
     * @return the exception to throw, or null to throw tisana default
     * exception.
     */
    RestException translateException( int responseCode, String responseMessage, String bodyMessage,
